    ...
    >
      <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
        <motion.h2
          ...
          style={{ color: "var(--color-white)", fontFamily: "var(--font-roboto)" }}
        ...
        <motion.p
          ...
          style={{ color: "rgba(255,255,255,0.85)", fontFamily: "var(--font-roboto)" }}
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        >
          ...
          <a
            ...
            style={{ color: "rgba(255,255,255,0.9)", fontFamily: "var(--font-roboto)" }}
          >
